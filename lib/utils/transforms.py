...
def crop(img, center, scale, output_size, rot=0):
    ...
    if sf < 2:
        ...
        if new_size < 2:
            ...
            img = scipy.ndimage.interpolation.rotate(img, [new_ht, new_wd]) 
    ...
    if not rot == 0:
        ...
        new_img = scipy.ndimage.interpolation.rotate(new_img, rot) #MAX: deprecated: scipy.misc.imrotate(new_img, rot)
